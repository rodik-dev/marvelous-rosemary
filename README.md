...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5ff35b756d1a97001c99c093
...
To start editing your site, you can use the Sanity interface at https://marvelous-rosemary-35b75.sanity.studio/.
...
Generated at `2021-01-04T18:16:37.739Z` by Stackbit version `0.3.42`.